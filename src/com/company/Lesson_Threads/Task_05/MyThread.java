...
import com.company.OOP.Test_polymorf;
...
public class MyThread {
    ...
    public static void main(String[] args)   throws InterruptedException{
        Violin violin = new Violin("Vasia");
        Thread t = new Thread(violin);
        t.start();
        sleepNSeconds((long)20);
    }
    ...
    public static void sleepNSeconds(long n) {
        try {
            Thread.sleep(n * delay);
        } catch (InterruptedException e) {
            e.printStackTrace();
